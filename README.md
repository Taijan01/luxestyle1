...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Вкладки (табы) для фильтрации товаров */
        .products-filter {
            display: flex;
            justify-content: center;
            flex-wrap: wrap;
...
<body>
    <!-- Загрузочный экран (кнопка "Войти" удалена) -->
    <div id="loader">
        <div class="loader-content">
            ...
            <!-- Кнопка "Войти" полностью удалена -->
    ...
    <script>
        ...
        function initLoader() {
            ...
            // Анимируем прогресс бар (он же скроет загрузчик)
            animateProgressBar();
        }
        ...
        function animateProgressBar() {
            ...
            const interval = setInterval(() => {
                ...
                if (progress >= 100) {
                    ...
                    // Автоматически скрываем загрузчик и запускаем конфетти
                    hideLoader();
                }
            }, 25);
        }
